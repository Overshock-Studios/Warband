 ...
 *   <li>Stamp each spawned mob with its difficulty value (via the Fabric Data
 *       Attachment API — see {@link com.warband.entity.WarbandAttachments}) so
 *       the mob carries its own level and other mods can read it.</li>
